        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-4">
              Community Connect brings neighbors together by connecting service providers with community members. 
              Building stronger communities, one connection at a time.
            </p>
            <Link to="/about" className="text-sm text-primary-400 hover:text-primary-300 transition-colors">
              Learn More →
            </Link>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:contact@communityconnect.com" className="text-sm hover:text-primary-400 transition-colors">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm text-gray-400 mt-2 md:mt-0">
              ...
              <a
                href="https://nilesh-pawar-portfolio.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-primary-400 font-semibold hover:text-primary-300 transition-colors underline"
              >
                Nilesh D Pawar
              </a>
            </p>
