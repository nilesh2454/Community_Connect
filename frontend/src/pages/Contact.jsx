        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <a href="mailto:contact@communityconnect.com" className="text-primary-600 hover:text-primary-700">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Visit us Monday - Friday, 9 AM - 6 PM
                </p>
              </div>
            </div>
          ...
          <div className="mt-8 p-6 bg-gray-50 rounded-lg">
            ...
            <div className="space-y-3">
              <div>
                <h4 className="font-medium text-gray-900 mb-1">How quickly will I receive a response?</h4>
                <p className="text-sm text-gray-600">
                  We aim to respond to all inquiries within 24 hours during business days.
                </p>
              </div>
              <div>
                <h4 className="font-medium text-gray-900 mb-1">Can I visit your office?</h4>
                <p className="text-sm text-gray-600">
                  Yes! We welcome visitors during our business hours. Please call ahead to schedule an appointment.
                </p>
              </div>
              <div>
                <h4 className="font-medium text-gray-900 mb-1">Do you offer phone support?</h4>
                <p className="text-sm text-gray-600">
                  Absolutely! Call us at +1 (234) 567-890 during business hours for immediate assistance.
                </p>
              </div>
            </div>
          </div>
